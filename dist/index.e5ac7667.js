...
const getCards = async ()=>{
    ...
    if (response.status !== 200) throw new Error("Cannot fetch the data"); // ett nytt "error-objekt", visas om det är något problem med url'n.
    const data = await response.json();
    return data;
};
getCards().then((dataValue)=>{
    let output = "";
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dyO8b","aitAD"], "aitAD", "parcelRequire261a")
